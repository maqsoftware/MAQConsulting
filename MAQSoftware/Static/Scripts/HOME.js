...
(function () {
    ...
    var oExpertiseSlider = {
        ...
        imageContent: ["Optimized data warehouse, customized  reports, dashboards, faster and better decision making",
    ...
    var iLastWindowWidth = $(window).width();
    $('document').ready(function () {
        ...
        function NavigateToExpetisePage(oClickedElement) {
            ...
            var iIndex = $.inArray(sSliderTitle, oExpertiseSlider.imageTitle);
            if (iIndex == -1) {
                iIndex = 0;
            }
        ...
        function ChangeCDSliderContent(sCurrentSelected, oCurrentElement) {
            ...
            if (oPos.length) {
                var iImageIndex = sCurrentSelected;
                var sPreviousImageIndex = oDeliveryApproachContent.previousIndex;
                if (sPreviousImageIndex != iImageIndex) {
                    var oPreviousImage = $(".dvDeliveryApproachIcon div[id=CD" + sPreviousImageIndex + "]");
                ...
                var sContent = oDeliveryApproachContent.content[iImageIndex];
                var sContentTitle = oCurrentElement.attr("title");
                if (sContent)
        ...
        function ResetClientSlider() {
            ...
            var iWrapperWidth = iWindowWidth - 80;
            if (iWindowWidth < 1000) {
                $(".ClientImageWrapper").width(iWrapperWidth);
                var iNumImages = parseInt(iWrapperWidth / oClientSlider.size);
